...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "c0cc72572a8b2053afa95d7227bc5af478cdbe97133e92e043c2e0a4336f3df3",
        strip_prefix = "github.com/mgechev/revive@v1.14.0",
        urls = [
            "http://bazel-cache.pingcap.net:8080/gomod/github.com/mgechev/revive/com_github_mgechev_revive-v1.14.0.zip",
            "http://ats.apps.svc/gomod/github.com/mgechev/revive/com_github_mgechev_revive-v1.14.0.zip",
            "https://cache.hawkingrei.com/gomod/github.com/mgechev/revive/com_github_mgechev_revive-v1.14.0.zip",
            "https://storage.googleapis.com/pingcapmirror/gomod/github.com/mgechev/revive/com_github_mgechev_revive-v1.14.0.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "f72cf2fb70b8da5a35535f32cc613634b1348e2fd2016133a63d8ba6e70bbc74",
        strip_prefix = "git.pingcap.net/pingkai/kvproto@v0.0.0-20260311024618-bdebdc2ef7d2",
        urls = [
            "http://bazel-cache.pingcap.net:8080/gomod/git.pingcap.net/pingkai/kvproto/net_pingcap_git_pingkai_kvproto-v0.0.0-20260311024618-bdebdc2ef7d2.zip",
            "http://ats.apps.svc/gomod/git.pingcap.net/pingkai/kvproto/net_pingcap_git_pingkai_kvproto-v0.0.0-20260311024618-bdebdc2ef7d2.zip",
            "https://cache.hawkingrei.com/gomod/git.pingcap.net/pingkai/kvproto/net_pingcap_git_pingkai_kvproto-v0.0.0-20260311024618-bdebdc2ef7d2.zip",
            "https://storage.googleapis.com/pingcapmirror/gomod/git.pingcap.net/pingkai/kvproto/net_pingcap_git_pingkai_kvproto-v0.0.0-20260311024618-bdebdc2ef7d2.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "10fa14fe143ef05fcf8f449628c37448b83aed14e7ed25afc7371c31632de1a9",
        strip_prefix = "git.pingcap.net/pingkai/client-go/v2@v2.0.8-0.20260311025438-02c3ccb91f31",
        urls = [
            "http://bazel-cache.pingcap.net:8080/gomod/git.pingcap.net/pingkai/client-go/v2/net_pingcap_git_pingkai_client_go_v2-v2.0.8-0.20260311025438-02c3ccb91f31.zip",
            "http://ats.apps.svc/gomod/git.pingcap.net/pingkai/client-go/v2/net_pingcap_git_pingkai_client_go_v2-v2.0.8-0.20260311025438-02c3ccb91f31.zip",
            "https://cache.hawkingrei.com/gomod/git.pingcap.net/pingkai/client-go/v2/net_pingcap_git_pingkai_client_go_v2-v2.0.8-0.20260311025438-02c3ccb91f31.zip",
            "https://storage.googleapis.com/pingcapmirror/gomod/git.pingcap.net/pingkai/client-go/v2/net_pingcap_git_pingkai_client_go_v2-v2.0.8-0.20260311025438-02c3ccb91f31.zip",
        ],
    )
    go_repository(
        ...
        sha256 = "3d277fd8ac9b2682a61ca33d0174c4ba5f3d82a68e53ffe6c15cbec5e9b72b20",
        strip_prefix = "git.pingcap.net/pingkai/pd/client@v0.0.0-20260311025246-479a3e91ca04",
        urls = [
            "http://bazel-cache.pingcap.net:8080/gomod/git.pingcap.net/pingkai/pd/client/net_pingcap_git_pingkai_pd_client-v0.0.0-20260311025246-479a3e91ca04.zip",
            "http://ats.apps.svc/gomod/git.pingcap.net/pingkai/pd/client/net_pingcap_git_pingkai_pd_client-v0.0.0-20260311025246-479a3e91ca04.zip",
            "https://cache.hawkingrei.com/gomod/git.pingcap.net/pingkai/pd/client/net_pingcap_git_pingkai_pd_client-v0.0.0-20260311025246-479a3e91ca04.zip",
            "https://storage.googleapis.com/pingcapmirror/gomod/git.pingcap.net/pingkai/pd/client/net_pingcap_git_pingkai_pd_client-v0.0.0-20260311025246-479a3e91ca04.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        name = "net_pingcap_git_pingkai_tigateway",
        build_file_proto_mode = "disable_global",
        importpath = "git.pingcap.net/pingkai/tigateway",
        sha256 = "03c16989015c9953d93fb1a8fb8858463c2a19c70f6c6c14671e283b3b8b979a",
        strip_prefix = "git.pingcap.net/pingkai/tigateway@v0.0.0-20250827135949-571b07ebeac7",
        urls = [
            "http://bazel-cache.pingcap.net:8080/gomod/git.pingcap.net/pingkai/tigateway/net_pingcap_git_pingkai_tigateway-v0.0.0-20250827135949-571b07ebeac7.zip",
            "http://ats.apps.svc/gomod/git.pingcap.net/pingkai/tigateway/net_pingcap_git_pingkai_tigateway-v0.0.0-20250827135949-571b07ebeac7.zip",
            "https://cache.hawkingrei.com/gomod/git.pingcap.net/pingkai/tigateway/net_pingcap_git_pingkai_tigateway-v0.0.0-20250827135949-571b07ebeac7.zip",
            "https://storage.googleapis.com/pingcapmirror/gomod/git.pingcap.net/pingkai/tigateway/net_pingcap_git_pingkai_tigateway-v0.0.0-20250827135949-571b07ebeac7.zip",
        ],
    )
    go_repository(
