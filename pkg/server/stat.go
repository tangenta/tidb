...
var defaultStatus = map[string]*variable.StatusVal{
	...
	tlcpEncNotAfter:  {Scope: vardef.ScopeGlobal | vardef.ScopeSession, Value: ""},
	tlcpEncNotBefore: {Scope: vardef.ScopeGlobal | vardef.ScopeSession, Value: ""},
	tlcpSigNotAfter:  {Scope: vardef.ScopeGlobal | vardef.ScopeSession, Value: ""},
	tlcpSigNotBefore: {Scope: vardef.ScopeGlobal | vardef.ScopeSession, Value: ""},
}
