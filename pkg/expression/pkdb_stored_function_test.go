...
func TestStoredFuncSigCloneDoesNotShareCallStmt(t *testing.T) {
	...
	origEnableProcedure := vardef.TiDBEnableProcedureValue.Load()
	vardef.TiDBEnableProcedureValue.Store(true)
	t.Cleanup(func() {
		vardef.TiDBEnableProcedureValue.Store(origEnableProcedure)
	})
