...
func TestTiDBEncodeKey(t *testing.T) {
	...
	tk.MustQuery("select tidb_encode_record_key('test', 't', 1);").
		Check(testkit.Rows("7480000000000000885f728000000000000001"))
	...
	tk.MustQuery("select tidb_encode_index_key('test', 't', 'i', 1, 1);").
		Check(testkit.Rows("7480000000000000885f698000000000000001038000000000000001038000000000000001"))

	tk.MustExec("create table t1 (a int primary key, b int) partition by hash(a) partitions 4;")
	tk.MustExec("insert into t1 values (1, 1);")
	tk.MustQuery("select tidb_encode_record_key('test', 't1(p1)', 1);").Check(testkit.Rows("74800000000000008d5f728000000000000001"))
	rs := tk.MustQuery("select tidb_mvcc_info('74800000000000008d5f728000000000000001');")
	...
	tk2.MustQuery("select tidb_encode_record_key('test', 't1(p1)', 1);").Check(testkit.Rows("74800000000000008d5f728000000000000001"))
}
