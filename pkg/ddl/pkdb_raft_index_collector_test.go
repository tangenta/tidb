...
func (c *testPkdbCollectorPDClient) GetAllStores(context.Context, ...opt.GetStoreOption) ([]*metapb.Store, error) {
	return c.stores, nil
}

func (c *testPkdbCollectorPDClient) GetStore(_ context.Context, storeID uint64, opts ...opt.GetStoreOption) (*metapb.Store, error) {
...
func (c *testPkdbCollectorPDClient) BatchScanRegions(_ context.Context, keyRanges []router.KeyRange, limit int, _ ...opt.GetRegionOption) ([]*router.Region, error) {
	startKey := []byte{}
	if len(keyRanges) > 0 {
