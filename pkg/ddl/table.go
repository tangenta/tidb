...
func checkTableNotExists(infoCache *infoschema.InfoCache, schemaID int64, tableName ast.CIStr) error {
	is := infoCache.GetLatest()
...
func checkTableNotExistsFromInfoSchema(is infoschema.InfoSchema, schemaID int64, tableName ast.CIStr) error {
	// Check this table's database.
