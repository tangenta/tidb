...
func preSplitIndexRegions(
	...
	for i, idxInfo := range allIndexInfos {
		...
		if BeforePreSplitIndexKeysForTest != nil {
			BeforePreSplitIndexKeysForTest(splitKeys)
		}
...
// BeforePreSplitIndexKeysForTest is only used for test.
var BeforePreSplitIndexKeysForTest func([][]byte)
