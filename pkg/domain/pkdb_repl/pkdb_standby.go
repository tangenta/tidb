...
type domainCloser interface {
	Close()
	// CloseKSSessMgr is not used. Just add some domain methods to this interface to avoid
	// the implementation of domainCloser is not Domain.
	CloseKSSessMgr(string)
}
